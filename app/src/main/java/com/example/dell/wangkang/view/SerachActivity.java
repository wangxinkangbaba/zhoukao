...
public class SerachActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        for (int i = 0; i < mVals.length; i++) {
            ...
            tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //加入搜索历史纪录记录
                    Toast.makeText(SerachActivity.this, str, Toast.LENGTH_LONG).show();
                }
            });
    ...
    public void cleanHistory() {
        ...
        mArrAdapter.notifyDataSetChanged();
        mSearchHistoryLl.setVisibility(View.GONE);
        Toast.makeText(SerachActivity.this, "清楚搜索历史成功", Toast.LENGTH_LONG).show();
    }
        ...
        switch (v.getId()) {
            case R.id.btn_search:
                ...
                if (!TextUtils.isEmpty(keywords)) {
                    Toast.makeText(SerachActivity.this, keywords + "save成功", Toast.LENGTH_LONG).show();
                    save();
                    if ("购物车".equals(keywords)){
                        Intent intent=new Intent(SerachActivity.this,MainActivity.class);
                        startActivity(intent);
                    }
                }
                else {
                    Toast.makeText(SerachActivity.this, "请输入搜索内容", Toast.LENGTH_LONG).show();
                }
                break;
